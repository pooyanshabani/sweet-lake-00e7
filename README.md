...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/sweet-lake-application
```

A live public deployment of this template is available at [https://sweet-lake-application.templates.workers.dev](https://sweet-lake-application.templates.workers.dev)
